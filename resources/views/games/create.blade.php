...
<div class="max-w-2xl mx-auto px-8 py-12">
    ...
    <div class="flex items-end justify-between mb-8">
        <div>
            <div class="flex items-center gap-2 mb-1">
                ...
                <span class="text-xs tracking-[4px] uppercase text-purple-400 font-semibold">Tambah Data</span>
            </div>
            <h1 class="font-orbitron text-3xl font-black text-white glow-purple m-0">NEW GAME</h1>
        </div>
    ...
    {{-- Form Panel --}}
    <div class="relative bg-white/[0.02] border border-purple-500/20 rounded-md p-8">
        ...
        <form action="{{ route('games.store') }}" method="POST" class="flex flex-col gap-6 relative z-10">
            @csrf
    ...
    <div class="relative">
        ...
        <input type="text" name="nama_game" placeholder="Contoh: Valorant" 
               class="w-full bg-[#0b0c16] border border-purple-500/30 pl-12 pr-4 py-3 rounded-md text-purple-100 placeholder-purple-500/30 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 focus:shadow-[0_0_15px_rgba(168,85,247,0.4)] transition-all font-medium tracking-wide">
    </div>
</div>
    ...
    <div class="relative">
        ...
        <input type="number" name="max_player" placeholder="Contoh: 5" min="1"
               class="w-full bg-[#0b0c16] border border-pink-500/30 pl-12 pr-4 py-3 rounded-md text-pink-100 placeholder-pink-500/30 focus:outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500 focus:shadow-[0_0_15px_rgba(236,72,153,0.4)] transition-all font-medium tracking-wide">
    </div>
</div>
            ...
            <div class="mt-4 flex justify-end">
                <button type="submit"
                        class="btn-add-clip inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold text-sm tracking-widest uppercase shadow-[0_0_24px_rgba(168,85,247,0.4)] hover:shadow-[0_0_40px_rgba(168,85,247,0.8)] hover:-translate-y-0.5 transition-all">
